      ...
      <div className="flex flex-col items-center ">
        ...
        >
          <div className={"grid grid-cols-3 justify-items-center w-full "}>
            {" "}
            {/* Añadir un div contenedor o usar Fragment */}
            ...
            {tokensForOwnerState.length < 3 &&
              Array.from(Array(3 - tokensForOwnerState.length).keys()).map(
                (index) => (
        ...
        <CardsContainer className="bg-green-acrylic" title="Selected Cards">
        ...
        <div
          style={{ ...containerStyles, flexDirection: "column" }}
